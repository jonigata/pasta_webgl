...
private:
    ...
    public:
        ...
        std::string name() {
            return "X" + std::to_string(this->id());
        }
        ...
        void pass2(char* b) {
            ...
            *((std::uint32_t*)p) = 1;        p += 4;
            *((float*)p) = p_.x();         p += 4;
            *((float*)p) = p_.y();         p += 4;
            *((std::uint32_t*)p) = car_ ? car_->get_addr(): 0; p += 4;
            *((std::uint32_t*)p) = cdr_ ? cdr_->get_addr(): 0;
        }
    ...
    public:
        ...
        std::string name() {
            return "Y" + std::to_string(this->id());
        }
    ...
    public:
        ...
        std::string name() {
            return "S" + std::to_string(this->id());
        }
    ...
    bool find(
      ...
      OPCODE1: {
            ...
            if (q.x()<x ||(q.x() == x && q.y()<y)) {
                offset = *((std::uint32_t*)(p+12));
            } else {
                offset = *((std::uint32_t*)(p+16));
            }
      ...
      OPCODE2: {
            ...
            int offset;
            if (q.y()<y) {
                offset = *((std::uint32_t*)(p+28));
            } else {
                offset = *((std::uint32_t*)(p+32));
            }
            if (offset == 0) { return false; }
            p = b + offset;
        }
            ...
            switch (*((int*)p)) {
                ...
                case 1:
                    ...
                    os << ind(2)<< "(q.x() == float(" << *((float*)(p+4))
                       << ")&& q.y()<float(" << *((float*)(p+8))<< "))) { "
                       << std::endl;
                    os << ind(3)<< "goto ADDR" << *((std::uint32_t*)(p+12))
                       << ";" << std::endl;
                    os << ind(2)<< " } else { " << std::endl;
                    os << ind(3)<< "goto ADDR" << *((std::uint32_t*)(p+16))
                       << ";" << std::endl;
                ...
                case 2: {
                    ...
                    os << ind(3)<< "goto ADDR" << *((std::uint32_t*)(p+28))
                       << ";" << std::endl;
                    os << ind(2)<< " } else { " << std::endl;
                    os << ind(3)<< "goto ADDR" << *((std::uint32_t*)(p+32))
                       << ";" << std::endl;
                    os << ind(2)<< " }" << std::endl << std::endl;
